...
console.log(reverseCharacters('I like LaunchCode.'))
...
function reverseCharacters(str) {
   let lettersArray = str.toString().split('').reverse().join('');
   if (typeof str === 'string') {
   return lettersArray; 
   } else (typeof str === Number)
   return (Number(lettersArray));
}
console.log(reverseCharacters(1234))
console.log(reverseCharacters('LC101'))
console.log(reverseCharacters(98765))
...
function reverseArray(array) {
   ...
   for (let i = 0; i < array.length; i++) {
     emptyArray[i] = reverseCharacters(array[i]);
